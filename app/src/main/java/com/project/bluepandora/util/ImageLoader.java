...
public abstract class ImageLoader {
     ...
     * {@link com.project.bluepandora.util.ImageLoader#processBitmap(Object)} to define the processing
     * logic). If the image is found in the memory cache, it is set immediately,
     * otherwise an {@link android.os.AsyncTask} will be created to asynchronously load the
     * bitmap.
     *
     ...
     *
     * @param fragmentManager     A FragmentManager to use to retain the cache over
     ...
     *             {@link com.project.bluepandora.util.ImageLoader#loadImage(Object, android.widget.ImageView)}
