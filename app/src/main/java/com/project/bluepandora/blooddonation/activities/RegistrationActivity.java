...
public class RegistrationActivity extends ActionBarActivity {
	...
	/*
	 * http://www.sustcse11.net/donateLife/data.php?requestName=hospitalList
	 * 
	 * http://www.sustcse11.net/donateLife/data.php?requestName=districtList
	 * 
	 * http://www.sustcse11.net/donateLife/data.php?requestName=bloodGroupList
	 * 
	 * http://www.sustcse11.net/donateLife/data.php
	 * ?requestName=isRegistered&mobileNumber=01937595521
	 */
