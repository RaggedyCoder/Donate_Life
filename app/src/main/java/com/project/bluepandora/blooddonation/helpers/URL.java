package com.project.bluepandora.blooddonation.helpers;

public interface URL {
	public static final String URL = "http://www.sustcse11.net/donateLife/adatap.php";
	...
	public static final String PASSWORD_TAG = "keyWord";
	public static final String REQUESTTIME_TAG = "reqTime";
