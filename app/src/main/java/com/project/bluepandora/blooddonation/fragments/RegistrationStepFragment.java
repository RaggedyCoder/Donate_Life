...
public class RegistrationStepFragment extends Fragment {
	...
	public String TAG = RegistrationStepFragment.class.getSimpleName();
	public ArrayList<DistrictItem> dist;
	public JSONObject jsonObject;
	public String mobileNumber;
	public Button avatar;
	public TextView mobileNumberView;
	public BloodSpinnerAdapter bloodAdapter;
	public DistrictSpinnerAdapter districtAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				params.put(URL.REQUEST_NAME, URL.REGISTER_REQUEST);
						...
						try {
							...
							if (done == 1) {
								Toast.makeText(getActivity(),
										"Registration Successful", 0).show();
							}else{
