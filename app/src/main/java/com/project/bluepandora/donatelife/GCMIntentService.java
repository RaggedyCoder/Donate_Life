...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    private static void generateNotification(Context context, String message) {
        ...
        String strRingtonePreference = prefs.getString(SettingsActivity.RINGTONE_TAG, "DEFAULT_RINGTONE_URI");
    ...
    protected void onMessage(Context context, Intent intent) {
        ...
        Log.e(TAG, message);
        if (PreferenceManager.getDefaultSharedPreferences(context).getBoolean(SettingsActivity.NOTIFICATION_TAG, true)) {
    ...
    public void onError(Context context, String errorId) {
        Log.i(TAG, "Received error: " + errorId + " " + getString(R.string.gcm_error, errorId));
    }

    @Override
    protected boolean onRecoverableError(Context context, String errorId) {
        // log message
        Log.i(TAG, "Received recoverable error: " + errorId + " " + getString(R.string.gcm_recoverable_error, errorId));
