 ...
 * either the {@link nineoldandroids.animation.AnimatorSet#playTogether(Animator[]) playTogether()} or
 * {@link nineoldandroids.animation.AnimatorSet#playSequentially(Animator[]) playSequentially()} methods can be called to add
 * a set of animations all at once, or the {@link nineoldandroids.animation.AnimatorSet#play(Animator)} can be
 * used in conjunction with methods in the {@link nineoldandroids.animation.AnimatorSet.Builder Builder}
...
public final class AnimatorSet extends Animator {
     ...
     * nineoldandroids.animation.AnimatorSet#play(Animator) play()} method of <code>AnimatorSet</code> is to make it possible
     * to express the dependency relationships of animations in a natural way. Developers can also
     * use the {@link nineoldandroids.animation.AnimatorSet#playTogether(Animator[]) playTogether()} and {@link
     * nineoldandroids.animation.AnimatorSet#playSequentially(Animator[]) playSequentially()} methods if these suit the need,
     * but it might be easier in some situations to express the AnimatorSet of animations in pairs.
     * <p/>
     * <p>The <code>Builder</code> object cannot be constructed directly, but is rather constructed
     * internally via a call to {@link nineoldandroids.animation.AnimatorSet#play(Animator)}.</p>
     * <p/>
     ...
     * </pre>
     * <p/>
     * <p>Note in the example that both {@link nineoldandroids.animation.AnimatorSet.Builder#before(Animator)} and {@link
     * nineoldandroids.animation.AnimatorSet.Builder#after(Animator)} are used. These are just different ways of expressing the same
     * relationship and are provided to make it easier to say things in a way that is more natural,
     * depending on the situation.</p>
     * <p/>
     * <p>It is possible to make several calls into the same <code>Builder</code> object to express
     * multiple relationships. However, note that it is only the animation passed into the initial
     * {@link nineoldandroids.animation.AnimatorSet#play(Animator)} method that is the dependency in any of the successive
    ...
    public class Builder {
         ...
         * {@link nineoldandroids.animation.AnimatorSet#play(Animator)} call that created this <code>Builder</code> object.
         *
         * @param anim The animation that will play when the animation supplied to the
         *             {@link nineoldandroids.animation.AnimatorSet#play(Animator)} method starts.
         */
         ...
         *
         * @param anim The animation that will play when the animation supplied to the
         *             {@link nineoldandroids.animation.AnimatorSet#play(Animator)} method ends.
         */
         ...
         *             {@link nineoldandroids.animation.AnimatorSet#play(Animator)} method to play.
         */
