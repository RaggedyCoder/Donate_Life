...
public class ValueAnimator extends Animator {
     ...
     * during a call to {@link nineoldandroids.animation.ValueAnimator.AnimatorUpdateListener#onAnimationUpdate(nineoldandroids.animation.ValueAnimator)}, which
     ...
     * {@link nineoldandroids.animation.ValueAnimator.AnimatorUpdateListener#onAnimationUpdate(nineoldandroids.animation.ValueAnimator)}, which
     * is called during each animation frame, immediately after the value is calculated.
     *
    ...
    public String toString() {
        String returnVal = "ValueAnimator@";
        if (mValues != null) {
